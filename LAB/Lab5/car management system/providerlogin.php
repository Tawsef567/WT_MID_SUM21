    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav mr-auto w-100 justify-content-end">
        <li class="nav-item active">
          ...
          <a class="nav-link" href="providersignup.php">Registration</a>
        </li>
      </ul>
    </div>
    </div>
...
<?php
      ...
      if(isset($_POST['submit']))
      {
        ...
        $username_search = "select * from provider where username='$username'";
        ...
        if($username_count)
        {
          ...
          {
            	echo "Login complete";
            	header('location: ../car management system/provider_dashboard\provider_dashboard.php');
          }
          else
          {
             echo "Wrong Password";
...
<form method="POST" action="<?php echo htmlentities($_SERVER['PHP_SELF']);?>">
        <fieldset>
        <legend style="color:cyan;"> <h1>Provider Login</h1></legend>
			<table>
