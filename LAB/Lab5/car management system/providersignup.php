    ...
    <div class="collapse navbar-collapse" id="collapsibleNavId">
      <ul class="navbar-nav mr-auto w-100 justify-content-end">
        <li class="nav-item active">
          ...
          <a class="nav-link" href="providerlogin.php">Login</a>
        </li>
      </ul>
    </div>
    </div>
...
<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $usernamequery = "select * from provider where username='$username'";
      ...
      else
      {
        ...
        {
          $insetquery = "insert into provider(username, fullname, email, password, repassword, phone, address, dob) values('$username','$fullname','$email','$pass','$repass', '$phone', '$address', '$dob')";
...
<!-- Database End -->
        ...
        <legend>Provider Signup</legend>
            ...
            <label>Already Have Account? <a href="providerlogin.php">Provider Login</a> </label>
		</form>
	</body>
</html>