...
<?php
    ...
    if(isset($_POST['submit']))
    {
      ...
      $usernamequery = "select * from customer where username='$username'";
      ...
      else
      {
        ...
        {
          $insetquery = "insert into customer(username, fullname, email, password, repassword, phone, address, dob) values('$username','$fullname','$email','$password','$repassword', '$phone', '$address', '$dob')";
...
<!-- Database End -->
        ...
        <legend>Customer Signup</legend>
            ...
            <label>Already Have Account? <a href="customer_login.php">Customer Login</a> </label>
		</form>
	</body>
</html>